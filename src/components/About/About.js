...
const About = () => {
  return (
    <div style={{
      ...
      <h3>Welcome to CryptoLedger!</h3>
      <p>
        At CryptoLedger, we believe in the transformative power of
        cryptocurrency and its potential to reshape the way we transact and
        store value. As a leading provider of secure and user-friendly crypto
        wallet solutions, we are committed to simplifying the management of
        digital assets for individuals and businesses alike.
      </p>
      <p>
        Our mission is to empower our users with complete control over their
        cryptocurrencies while prioritizing the highest standards of security.
        Whether you're an experienced crypto enthusiast or new to the world of
        digital currencies, our feature-rich wallet platform offers a seamless
        and intuitive experience for sending and receiving USDT, BTC, ETH, and
      ...
      <ol>
        ...
        <li>
          ...
          smooth experience for all our users
        </li>
      </ol>
      Join the thousands of satisfied users who trust CryptoLedger as their
      go-to platform for securely managing their digital assets. Sign up today
      and take charge of your cryptocurrency portfolio with confidence.
    </div>
  );
};
